            ...
            <div class="card-body">
                <form method="POST" action="/admin/positions/{{ $position->id }}">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" step="0.01" class="form-control" id="base_salary" name="base_salary" value="{{ $position->base_salary }}" required>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="d-grid gap-2">
                        <button type="submit" class="btn" style="background-color: #bf9de3ff; color: #070917ff;">Update Position</button>
